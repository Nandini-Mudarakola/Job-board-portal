            ...
            <div className='w-full min-h-[60vh] flex flex-col items-center justify-center'>
                <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 item-center gap-[2rem]'>
                    ...
                    <div>
                        ...
                        <p className='text-[#4f5e6f] text-[16px] md:text-[18px] mt-[1rem]'>Find your dream job with ease! Explore opportunities, apply quickly, and start your career journey today...</p>
                        {/* search box */}
