        ...
        <div className='pt-20 pb-12 bg-black'>
            <div className='w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-12 pb-8 border-b-2 border-white border-opacity-10'>
                ...
                <div>
                    ...
                    <p className='text-sm text-white text-opacity-70'>Find your dream job with ease! Explore opportunities, apply quickly, and start your career journey today.</p>
                    {/* social icons */}
                ...
                {/* 4th part of footer */}
                <FooterSection title={'Get in Touch'} data={['+91 8125207447', 'mudarakolanandini@gmail.com', 'India']} />
            </div>
        </div>
    )
}
